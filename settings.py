...
PLAYER_SWIM_WIDTH = TILE_SIZE * 1.8
PLAYER_SWIM_HEIGHT = TILE_SIZE * 1.35

WATER_GRAVITY = 500.0
SWIM_VELOCITY = -280.0
SWIM_SPEED = 140.0
EXIT_LIQUID_VELOCITY = -900.0
JAR_WIDTH = TILE_SIZE * 0.6
JAR_HEIGHT = TILE_SIZE * 0.8
JAR_PUSH_SPEED = 220.0
MOVING_PLATFORM_HEIGHT = TILE_SIZE * 0.4
...
#Moving platforms (start_col, start_row, end_col, end_row, width_in_tiles)
MOVING_PLATFORMS = [
    (17, 10, 30, 10, 3),
]
